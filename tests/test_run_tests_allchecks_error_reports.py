...
def test_all_checks_use_automatic_error_reports() -> None:
    ...
    expected_calls = (
        ...
        '"MCB-3D-Masshaltigkeit STEP/WRL" "build\\ALLE_PRUEFUNGEN_3D_MASSHALTIGKEIT.log" python tools\\export_z_mcb_3d.py --check-geometry',
    ...
    assert allchecks.count('tools\\windows\\run_with_error_report.bat') == 6
