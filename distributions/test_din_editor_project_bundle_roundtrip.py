"""Round-trip tests for DIN project bundles including synchronization history."""
from datetime import datetime, timezone

from .din_editor_project_bundle import export_project_bundle, import_project_bundle
...
def test_project_bundle_roundtrip_preserves_components_and_audit_history():
    ...
    restored_session, restored_log = import_project_bundle(export_project_bundle(session, log))
