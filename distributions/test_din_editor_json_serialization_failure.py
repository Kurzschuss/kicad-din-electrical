"""Failure-path test for JSON serialization during project saves."""
...
def test_json_serialization_failure_preserves_target_and_manager_state(
    ...
    monkeypatch.setattr(din_editor_project_bundle.json, "dumps", fail_dumps)
    ...
    try:
        ...
        raise AssertionError("JSON serialization failure was not reported")
