...
class ProjectOSUserManagementChangeTraceEmitter:
    ...
    def _change_context(self, operation: str) -> tuple[str, str | None, dict[str, Any] | None, dict[str, Any]]:
        ...
        mapping = {
            ...
            "user_reactivated": ("user_reactivations", "reactivation_id"),
        ...
        if operation in {"user_created", "user_weight_changed"}:
            actor = row["user_id"]
        elif operation == "user_deactivated":
            actor = row["deactivated_by_user_id"]
        elif operation == "user_reactivated":
            actor = row["reactivated_by_user_id"]
