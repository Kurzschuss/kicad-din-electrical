...
_DEFAULT_RULES = (
    ProjectOSUserManagementReversibilityRule(
        ...
        "Deaktivierung und Reaktivierung derselben user_id sind modelliert; der generische Kompensationsvertrag für user_created wird erst separat freigeschaltet."
    ),
    ProjectOSUserManagementReversibilityRule(
    ...
    ProjectOSUserManagementReversibilityRule(
        "user_deactivated", False, None,
        "Eine normale Benutzer-Deaktivierung bleibt historische Lifecycle-Tatsache und wird nicht rückwirkend entfernt."
    ),
    ProjectOSUserManagementReversibilityRule(
        "user_reactivated", False, None,
        "Eine normale Benutzer-Reaktivierung bleibt historische Lifecycle-Tatsache; ihre Undo/Redo-Nutzung wird nur über einen gesonderten Kompensationsvertrag erlaubt."
    ),
    ProjectOSUserManagementReversibilityRule(
        "permission_assigned", True, "revoke_assignment",
        "Undo erzeugt einen neuen Widerruf; Redo erzeugt einen neuen Regrant mit neuer assignment_id."
    ),
    ProjectOSUserManagementReversibilityRule(
        "permission_revoked", False, None,
        "Ein normaler Widerruf bleibt historische Tatsache. Nur ein als Undo erzeugter History-Eintrag kann den linearen Redo-Schritt tragen."
    ),
    ProjectOSUserManagementReversibilityRule(
        "permission_regranted", True, "revoke_assignment",
        "Ein Regrant ist eine neue aktive Zuweisung und kann durch einen neuen Widerruf kompensiert werden; erneutes Redo erzeugt wieder eine neue assignment_id."
    ),
    ProjectOSUserManagementReversibilityRule(
        "project_role_assigned", False, None,
        "Beendigung und Neu-Zuweisung sind explizit modelliert; die generische Undo/Redo-Kompensation bleibt wegen des Freigabe-Lifecycles gesperrt."
    ),
    ProjectOSUserManagementReversibilityRule(
        "project_role_assignment_terminated", False, None,
        "Die Beendigung bleibt historische Tatsache und wird nicht rückwirkend entfernt."
    ),
    ProjectOSUserManagementReversibilityRule(
        "project_role_reassigned", False, None,
        "Eine Rollen-Neu-Zuweisung ist ein neuer Lifecycle-Vorgang mit eigener Identität und nicht generisch kompensierbar."
    ),
    ProjectOSUserManagementReversibilityRule(
