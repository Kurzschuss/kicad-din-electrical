"""Failure-path test for flushing the temporary project file."""
...
def test_temporary_file_flush_failure_preserves_target_and_manager_state(
    ...
    class FailingTemporaryFile:
        ...
        def __enter__(self):
            ...
            class FailingFlusher:
                ...
                def flush(self):
                    raise OSError("simulated temporary-file flush failure")

                def __getattr__(self, name):
                    return getattr(handle, name)

            return FailingFlusher()
    ...
    try:
        ...
        raise AssertionError("temporary-file flush failure was not reported")
