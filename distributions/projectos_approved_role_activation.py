...
Auch administrative High/critical-Rollenzuweisungs-Beendigungen wirken nur über den
vorhandenen Approval-Vertrag. Historische Aktivierungen/Freigaben bleiben erhalten.
"""
...
class ProjectOSApprovedRoleActivationEvaluator:
    ...
    def _termination_state(self, *, project_id: str, user: ProjectOSUserProfile, scope: str, at: datetime | None) -> tuple[ProjectOSApprovedRoleAssignmentTerminationEvaluator, dict[str, Any]]:
        evaluator = ProjectOSApprovedRoleAssignmentTerminationEvaluator(
            roles=self.roles,
            terminations=self.role_terminations,
