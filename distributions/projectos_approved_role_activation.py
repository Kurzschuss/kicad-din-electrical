...
Rollen-/Aktivierungs-Lifecycle bleibt historisch sichtbar. Die daraus projizierte
Rechtewirkung folgt dem aktuellen chronologischen Benutzer-Lifecycle.
"""
...
class ProjectOSApprovedRoleActivationEvaluator:
    def __init__(
        ...
        *,
        ...
        self.user_lifecycle = ProjectOSUserLifecycleEvaluator(
            deactivations=self.user_deactivations,
            reactivations=self.user_reactivations,
        )
        self.risk_class_map = {
    ...
    def _termination_state(
        ...
        *,
        ...
        scope: str,
        at: datetime | None,
    ) -> tuple[ProjectOSApprovedRoleAssignmentTerminationEvaluator, dict[str, Any]]:
    ...
    def state(
        ...
        *,
        ...
        termination_evaluator, termination_state = self._termination_state(
            project_id=project_id,
            user=user,
            scope=scope,
            at=at,
        )
        effective_terminations = termination_evaluator.effective_terminations(
            project_id=project_id,
            user=user,
            scope=scope,
            at=at,
        ...
        lifecycle = self.user_lifecycle.state(user_id=user.user_id, at=at)
        return {
            ...
            "user_deactivation": lifecycle["latest_event"] if lifecycle["latest_event_type"] == "deactivated" else None,
            "user_reactivation": lifecycle["latest_event"] if lifecycle["latest_event_type"] == "reactivated" else None,
            "read_only": True,
        }
