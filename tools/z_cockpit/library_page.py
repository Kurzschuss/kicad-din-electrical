...
def library_page_html(libraries: tuple[SymbolLibrary, ...] | None = None) -> str:
    ...
    return (
        ...
        '.library-inspector{min-width:0;min-height:0;height:100%;padding:1rem;display:flex;'
        'flex-direction:column;overflow:hidden;border-left:1px solid #8886}'
        '.library-inspector>h2{margin-top:0;flex:0 0 auto}'
        '#library-symbol-inspector{min-height:0;flex:1 1 auto;display:flex;flex-direction:column;overflow:hidden}'
        '.library-inspector-fixed{flex:0 0 auto}'
        ...
        '.library-device-ids{list-style:none;padding:0;margin:0;display:grid;gap:.45rem}'
        ...
        '.library-inspector{height:auto;overflow:auto;border-left:0;border-top:1px solid #8886}'
        '#library-symbol-inspector{overflow:visible}'
        '.library-device-id-scroll{max-height:18rem}'
        ...
        'empty.textContent="Keine Gerätezuordnung.";idsScroll.appendChild(empty);}else{const list=document.createElement("ul");'
        ...
        'code.textContent=id;li.appendChild(code);list.appendChild(li);});idsScroll.appendChild(list);}idsSection.appendChild(idsScroll);'
        'inspector.appendChild(idsSection);}'
