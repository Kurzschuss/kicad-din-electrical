...
def placeholder_pages_html() -> str:
    return "".join(
        ...
        for page in DEFAULT_PAGES
        if page.page_id not in {"start", "geraete", "bibliotheken", "sicherheit"}
    )
